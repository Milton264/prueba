...
create table if not exists public.system_settings (
  ...
  contact_email     text not null default 'info@panamaenergysolutions.com',
  whatsapp_number   text not null default '50760000000',
  website_url       text,
  address           text default 'Ciudad de Panama, Republica de Panama',
